...
NCountry = {
	...
	SPECIAL_FORCES_CAP_MIN = 90,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NPolitics = {
	BASE_LEADER_TRAITS = 6,				-- Base amount of leader traits.
...
NMilitary = {
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.00,			   -- Base xp gain for traits per hour for armies
	MAX_NUM_TRAITS = 10,						   -- cant have more, -1 to disable
